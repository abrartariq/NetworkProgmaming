## Homework 3: Recursive DNS Resolver
 ...
 * **3 points**: Implement a caching system, so that exact duplicate lookups for
   ...
   `python3 resolve.py uic.edu uic.edu`, should result in the same number of
...
This assignment is due **November 3rd at 11:55pm**.  Get started early.  You have
