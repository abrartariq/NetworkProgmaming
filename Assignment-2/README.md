...
For your answer, put every IP addresses on a single line, comma separated,
...
**hints**:
  ...
  * practice using filters in wireshark to better focus in on the traffic you
    are interested in.
...
network traffic in a pcap file, called `hw2.pcap`.
...
## Due Date
This homework is due before 11:55pm on Sunday, October 11th.
